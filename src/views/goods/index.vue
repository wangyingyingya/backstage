  ...
  <div>
    ...
    >
      ...
      <el-form-item prop="code">
        <el-input v-model="searchMap.code" placeholder="商品编号" style="width:120px"></el-input>
      </el-form-item>
      <el-form-item prop="supplierName">
				<!-- el-input是组件,要在组件元素监听原生事件,需要使用v-on:原生事件名 .native="处理函数" -->
        <el-input readonly @click.native="dialogSupplierVisible=true" v-model="searchMap.supplierName" placeholder="选择供应商" style="width:120px"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-dialog title="编辑商品" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="进货商" prop="supplierName">
  ...
  methods: {
    ...
    optionSupplier(currentRow){
      ...
      if(this.isEdit){
        ...
        this.pojo.supplierId = currentRow.id  // 供应商
      }else{
        // 是搜索区域打开的选择供应商
        this.searchMap.supplierName = currentRow.name  //供应商名称
        this.searchMap.supplierId = currentRow.id  // 供应商
      }
      this.isEdit=false  // 注意从新赋值false
    ...
    editOptionSupplier(){
      this.isEdit=true  // 当前是通过编辑窗口中的选供应商打开的窗口
